	...
	<div class="col-sm-12 col-md-12">
		<div class="card">
			<div class="card-header" align="center">
				<h5>KPI Data import</h5>
			</div>
			<div class="card-block">
			
	<s:form action="KPIFileUpload" validate="true" namespace="/" method="post" enctype="multipart/form-data">
...
<div class="form-group row">
						<div class="col-md-12 text-center">
							<s:submit method="uploadKPIFile" class="btn waves-effect waves-light btn-info" value="Upload" theme="simple" />
							<input type="button" name="Exit" value="Exit" class="btn waves-effect waves-light btn-info" onClick="window.location.href='exitFileUpload';">
						</div>
					</div>
