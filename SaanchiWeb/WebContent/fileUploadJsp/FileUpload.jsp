...
<body oncontextmenu="return false;">
	...
	<s:form action="FileUpload" validate="true" namespace="/" method="post" enctype="multipart/form-data">
...
<div class="form-group row">
						<div class="col-md-12 text-center">
							<s:submit method="uploadFile" class="btn waves-effect waves-light btn-info" value="Upload" theme="simple" />
