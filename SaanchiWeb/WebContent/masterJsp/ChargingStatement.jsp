	...
	<div class="col-sm-12 col-md-12">
		<div class="card">
			<div class="card-header" align="center">
				<h5>Charging Statement Generation</h5>
					
			</div>
			<div class="card-block">
			
	<s:form action="ChargingStatementGeneration" validate="true" namespace="/" method="post">
...
<div class="form-group row">
						<div class="col-md-12 text-center">
							<s:submit method="generateFile" class="btn waves-effect waves-light btn-info" value="Generate" theme="simple" />
