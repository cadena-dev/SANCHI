...
<body oncontextmenu="return false;">
	...
	<s:form action="UserMasterEntry" validate="true" namespace="/" method="post">
...
<div class="form-group row">
						<div class="col-md-12 text-center">
							<s:submit method="addUserMaster" class="btn waves-effect waves-light btn-info" value="Add" theme="simple" />
							<input type="button" name="Back" value="Back" class="btn waves-effect waves-light btn-info" onClick="openList()">
							<input type="button" name="Exit" value="Exit" class="btn waves-effect waves-light btn-info" onClick="window.location.href='exitUserMaster';">
						</div>
					</div>
