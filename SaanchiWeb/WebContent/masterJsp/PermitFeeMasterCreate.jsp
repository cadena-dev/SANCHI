...
<body oncontextmenu="return false;">
	...
	<s:form action="PermitFeeMasterEntry" validate="true" namespace="/" method="post">
                    ...
                    <div class="form-group row">
						...
						<div class="col-6">
						 ...
						 <s:select headerKey=""
								...
								listValue="typeDesc" name="highway_authority_name" id="highway_authority_name"
								cssClass="form-control" theme="simple" required="required" />
							<s:fielderror fieldName="highway_authority_name" theme="saanchi"
...
<div class="form-group row">
						<div class="col-md-12 text-center">
							<s:submit method="addFeePermitMaster" class="btn waves-effect waves-light btn-info" value="Add" theme="simple" />
							<input type="button" name="Back" value="Back" class="btn waves-effect waves-light btn-info" onClick="openList()"> 
							<input type="button" name="Exit" value="Exit" class="btn waves-effect waves-light btn-info" onClick="window.location.href='exitFeePermitMaster';">
						</div>
					</div>
...
function loadWorkCategory(value)  
{
	  ...
	  try{
	    ...
	    var options='';   
	      ...
	      $.getJSON('workcategory_get.action', formInput,function(data) {
