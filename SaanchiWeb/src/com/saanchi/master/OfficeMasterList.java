...
public class OfficeMasterList extends ActionSupport implements ServletContextAware, ServletRequestAware {
	...
	List<OfficeCreateModel> officeMasterList = new ArrayList<OfficeCreateModel>();
	
	private static final Logger log = Logger.getLogger(OfficeMasterList.class);
	...
	public List<OfficeCreateModel> getOfficeMasterList() {
		return officeMasterList;
	}

	public void setOfficeMasterList(List<OfficeCreateModel> officeMasterList) {
	...
	public String execute() throws Exception {
		...
		try {
			...
			officeMasterList = new ArrayList<OfficeCreateModel>();
			

			officeMasterList = manager.searchOfficeMaster(officeMasterList);
			
			log.fatal("Office List Size "+officeMasterList.size());
	...
	@SkipValidation
	public String exitOfficeMasterList() throws Exception {
		return "home";
	}
	...
	public String deleteOfficeMaster() throws Exception {
		...
		try {
			...
			if ((this.office_master_id != null) && (this.office_master_id.length() > 0)) {
               ...
               boolean operationFlag = manager.updateOfficeMaster(officeModel,"DELETE");
