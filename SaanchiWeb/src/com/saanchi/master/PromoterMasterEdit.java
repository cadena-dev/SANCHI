...
public class PromoterMasterEdit extends ActionSupport implements ServletContextAware, ServletRequestAware {
	...
	private String promoter_master_id;
	private String isactive;

	private static final Logger log = Logger.getLogger(PromoterMasterEdit.class);
	...
	public String getPromoter_master_id() {
		return promoter_master_id;
	}

	public void setPromoter_master_id(String promoter_master_id) {
	...
	public String updatePromoterMaster() throws Exception {
		...
		try {
			...
			promoterModel.setPromoter_master_id(Integer.parseInt(promoter_master_id));
			promoterModel.setIsactive(isactive.equalsIgnoreCase("true")?true:false);
			...
			operationFlag = manager.updatePromoterMaster(promoterModel,"UPDATE");
...
public String deletePromoterMaster() throws Exception {
		...
		try {
			...
			promoterModel.setUpdated_by(Integer.parseInt(empID));
			promoterModel.setUpdated_datetime(currentDate);
			operationFlag = manager.updatePromoterMaster(promoterModel,"DELETE");
	...
	@SkipValidation
	public String exitPromoterMasterEdit() throws Exception {
		return "home";
	}
