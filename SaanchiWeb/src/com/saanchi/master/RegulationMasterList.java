...
public class RegulationMasterList extends ActionSupport implements ServletContextAware, ServletRequestAware {
	...
	List<RegulationMasterModel> regulationMasterList = new ArrayList<RegulationMasterModel>();
	
	private static final Logger log = Logger.getLogger(RegulationMasterList.class);
	...
	public List<RegulationMasterModel> getRegulationMasterList() {
		return regulationMasterList;
	}

	public void setRegulationMasterList(List<RegulationMasterModel> regulationMasterList) {
		this.regulationMasterList = regulationMasterList;
	}
	...
	public String execute() throws Exception {
		...
		try {
			...
			regulationMasterList = new ArrayList<RegulationMasterModel>();
			

			regulationMasterList = manager.searchRegulationMaster(regulationMasterList);
			
			log.fatal("Regulation List Size "+regulationMasterList.size());

			if (regulationMasterList.size() > 0) {
	...
	@SkipValidation
	public String exitRegulationMasterList() throws Exception {
		return "home";
	}
